...
public class LimitedUCTPlayer extends Player {
    ...
    public LimitedUCTPlayer(MoveGenerator generator, StopCriterion stop, int ucbLimit, double explorationWeight, Random rand) {
        super(String.format("LimUCT-%s-%s-%d-%.2f", generator.name(), stop.name(), ucbLimit, explorationWeight));
