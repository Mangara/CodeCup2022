...
public class MCTSPlayer extends Player {
    ...
    public MCTSPlayer(MoveGenerator generator, StopCriterion stop, double epsilon, Random rand) {
        super(String.format("MCTS-%s-%s-%.2f", generator.name(), stop.name(), epsilon));
    ...
    protected int selectMove() {
        ...
        int majority = (stop instanceof IterationCount ? ((IterationCount) stop).getMaxIterations() / 2 : Integer.MAX_VALUE);
