...
public class DecayingMCTSGenPlayer extends Player {
    ...
    public DecayingMCTSGenPlayer(MoveGenerator generator, MoveGenerator rolloutGenerator, StopCriterion stop, double epsilonStart, double epsilonEnd, Random rand) {
        super(String.format("MCTS-%s-%s-%s-%.2f-%.2f", generator.name(), rolloutGenerator.name(), stop.name(), epsilonStart, epsilonEnd));
