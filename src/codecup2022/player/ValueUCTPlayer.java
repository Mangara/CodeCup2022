...
public class ValueUCTPlayer extends Player {
    ...
    public ValueUCTPlayer(MoveGenerator generator, StopCriterion stop, double valueWeight, Random rand) {
        super(String.format("ValUCT-%s-%s-%.2f", generator.name(), stop.name(), valueWeight));
